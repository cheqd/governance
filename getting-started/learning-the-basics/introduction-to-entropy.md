...
At its mainnet launch, cheqd defined a set of baseline conditions and [parameters](../../how-governance-works/network-parameters.md) for the cheqd Network, using Cosmos’ inbuilt decentralised governance capabilities and [SDK](https://v1.cosmos.network/sdk).
